...
async function buildData() {
  ...
  const statusMoveEntries = {
    // Stat boosts
    'swords-dance': { name: 'Swords Dance', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 2 } } },
    'dragon-dance': { name: 'Dragon Dance', type: 'Dragon', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, spe: 1 } } },
    'nasty-plot': { name: 'Nasty Plot', type: 'Dark', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spa: 2 } } },
    'agility': { name: 'Agility', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spe: 2 } } },
    'calm-mind': { name: 'Calm Mind', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spa: 1, spd: 1 } } },
    'bulk-up': { name: 'Bulk Up', type: 'Fighting', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, def: 1 } } },
    'shell-smash': { name: 'Shell Smash', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 2, spa: 2, spe: 2 }, selfDrop: { def: -1, spd: -1 } } },
    'quiver-dance': { name: 'Quiver Dance', type: 'Bug', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spa: 1, spd: 1, spe: 1 } } },
    'geomancy': { name: 'Geomancy', type: 'Fairy', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { twoTurn: true, selfBoost: { spa: 2, spd: 2, spe: 2 } } },
    'iron-defense': { name: 'Iron Defense', type: 'Steel', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { def: 2 } } },
    'amnesia': { name: 'Amnesia', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spd: 2 } } },
    'acid-armor': { name: 'Acid Armor', type: 'Poison', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { def: 2 } } },
    'barrier': { name: 'Barrier', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { def: 2 } } },
    'rock-polish': { name: 'Rock Polish', type: 'Rock', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spe: 2 } } },
    'autotomize': { name: 'Autotomize', type: 'Steel', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spe: 2 } } },
    'cotton-guard': { name: 'Cotton Guard', type: 'Grass', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { def: 3 } } },
    'tail-glow': { name: 'Tail Glow', type: 'Bug', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { spa: 3 } } },
    'belly-drum': { name: 'Belly Drum', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { bellyDrum: true } },
    'coil': { name: 'Coil', type: 'Poison', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, def: 1 } } }, // Custom accuracy handling lacking
    'cosmic-power': { name: 'Cosmic Power', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { def: 1, spd: 1 } } },
    'hone-claws': { name: 'Hone Claws', type: 'Dark', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1 } } },
    'work-up': { name: 'Work Up', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, spa: 1 } } },
    'growth': { name: 'Growth', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { growth: true } },
    'shift-gear': { name: 'Shift Gear', type: 'Steel', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, spe: 2 } } },
    'no-retreat': { name: 'No Retreat', type: 'Fighting', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, def: 1, spa: 1, spd: 1, spe: 1 }, trapUser: true } },
    'victory-dance': { name: 'Victory Dance', type: 'Fighting', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, def: 1, spe: 1 } } },
    'clangorous-soul': { name: 'Clangorous Soul', type: 'Dragon', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { selfBoost: { atk: 1, def: 1, spa: 1, spd: 1, spe: 1 }, hpCost: 0.33 } },
    'minimize': { name: 'Minimize', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { minimize: true } },
    'double-team': { name: 'Double Team', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { evasion: 1 } },
    // Healing
    'roost': { name: 'Roost', type: 'Flying', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { healPerc: 0.5, roost: true } },
    'recover': { name: 'Recover', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { healPerc: 0.5 } },
    'soft-boiled': { name: 'Soft Boiled', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { healPerc: 0.5 } },
    'synthesis': { name: 'Synthesis', type: 'Grass', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weatherHeal: true } },
    'morning-sun': { name: 'Morning Sun', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weatherHeal: true } },
    'moonlight': { name: 'Moonlight', type: 'Fairy', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weatherHeal: true } },
    'slack-off': { name: 'Slack Off', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { healPerc: 0.5 } },
    'milk-drink': { name: 'Milk Drink', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { healPerc: 0.5 } },
    'shore-up': { name: 'Shore Up', type: 'Ground', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { shoreUp: true } },
    'rest': { name: 'Rest', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { rest: true } },
    'strength-sap': { name: 'Strength Sap', type: 'Grass', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { strengthSap: true } },
    // Status
    'spore': { name: 'Spore', type: 'Grass', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { status: 'SLP' } },
    'sleep-powder': { name: 'Sleep Powder', type: 'Grass', power: 0, accuracy: 75, category: 'Status', priority: 0, effects: { status: 'SLP' } },
    'hypnosis': { name: 'Hypnosis', type: 'Psychic', power: 0, accuracy: 60, category: 'Status', priority: 0, effects: { status: 'SLP' } },
    'yawn': { name: 'Yawn', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { yawn: true } },
    'sing': { name: 'Sing', type: 'Normal', power: 0, accuracy: 55, category: 'Status', priority: 0, effects: { status: 'SLP' } },
    'dark-void': { name: 'Dark Void', type: 'Dark', power: 0, accuracy: 50, category: 'Status', priority: 0, effects: { status: 'SLP' } },
    'lovely-kiss': { name: 'Lovely Kiss', type: 'Normal', power: 0, accuracy: 75, category: 'Status', priority: 0, effects: { status: 'SLP' } },
    'grass-whistle': { name: 'Grass Whistle', type: 'Grass', power: 0, accuracy: 55, category: 'Status', priority: 0, effects: { status: 'SLP' } },
    'will-o-wisp': { name: 'Will O Wisp', type: 'Fire', power: 0, accuracy: 85, category: 'Status', priority: 0, effects: { status: 'BRN' } },
    'toxic': { name: 'Toxic', type: 'Poison', power: 0, accuracy: 90, category: 'Status', priority: 0, effects: { status: 'TOX' } },
    'poison-powder': { name: 'Poison Powder', type: 'Poison', power: 0, accuracy: 75, category: 'Status', priority: 0, effects: { status: 'PSN' } },
    'poison-gas': { name: 'Poison Gas', type: 'Poison', power: 0, accuracy: 90, category: 'Status', priority: 0, effects: { status: 'PSN' } },
    'thunder-wave': { name: 'Thunder Wave', type: 'Electric', power: 0, accuracy: 90, category: 'Status', priority: 0, effects: { status: 'PAR' } },
    'stun-spore': { name: 'Stun Spore', type: 'Grass', power: 0, accuracy: 75, category: 'Status', priority: 0, effects: { status: 'PAR' } },
    'glare': { name: 'Glare', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { status: 'PAR' } },
    // Protection
    'protect': { name: 'Protect', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 4, effects: { protect: true } },
    'detect': { name: 'Detect', type: 'Fighting', power: 0, accuracy: 100, category: 'Status', priority: 4, effects: { protect: true } },
    // Weather
    'sunny-day': { name: 'Sunny Day', type: 'Fire', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weather: 'Sun' } },
    'rain-dance': { name: 'Rain Dance', type: 'Water', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weather: 'Rain' } },
    'sandstorm': { name: 'Sandstorm', type: 'Rock', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weather: 'Sand' } },
    'snowscape': { name: 'Snowscape', type: 'Ice', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weather: 'Snow' } },
    'hail': { name: 'Hail', type: 'Ice', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { weather: 'Snow' } },
    // Terrains
    'electric-terrain': { name: 'Electric Terrain', type: 'Electric', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { terrain: 'Electric' } },
    'grassy-terrain': { name: 'Grassy Terrain', type: 'Grass', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { terrain: 'Grassy' } },
    'misty-terrain': { name: 'Misty Terrain', type: 'Fairy', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { terrain: 'Misty' } },
    'psychic-terrain': { name: 'Psychic Terrain', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { terrain: 'Psychic' } },
    // Hazards
    'stealth-rock': { name: 'Stealth Rock', type: 'Rock', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { hazard: 'Stealth Rock' } },
    'spikes': { name: 'Spikes', type: 'Ground', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { hazard: 'Spikes' } },
    'toxic-spikes': { name: 'Toxic Spikes', type: 'Poison', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { hazard: 'Toxic Spikes' } },
    'sticky-web': { name: 'Sticky Web', type: 'Bug', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { hazard: 'Sticky Web' } },
    // Hazard control (Attacks but needed here for effects logic completion, Court Change is status)
    'court-change': { name: 'Court Change', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { swapHazards: true } },
    // Screens
    'reflect': { name: 'Reflect', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { screen: 'Reflect' } },
    'light-screen': { name: 'Light Screen', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { screen: 'Light Screen' } },
    'aurora-veil': { name: 'Aurora Veil', type: 'Ice', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { screen: 'Aurora Veil' } },
    // Utility
    'substitute': { name: 'Substitute', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { substitute: true } },
    'leech-seed': { name: 'Leech Seed', type: 'Grass', power: 0, accuracy: 90, category: 'Status', priority: 0, effects: { leechseed: true } },
    'taunt': { name: 'Taunt', type: 'Dark', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { taunt: true } },
    'encore': { name: 'Encore', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { encore: true } },
    'disable': { name: 'Disable', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { disable: true } },
    'trick': { name: 'Trick', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { trick: true } },
    'switcheroo': { name: 'Switcheroo', type: 'Dark', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { trick: true } },
    'haze': { name: 'Haze', type: 'Ice', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { clearBoosts: true } },
    'whirlwind': { name: 'Whirlwind', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: -6, effects: { phaze: true } },
    'roar': { name: 'Roar', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: -6, effects: { phaze: true } },
    'wish': { name: 'Wish', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { wish: true } },
    'healing-wish': { name: 'Healing Wish', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { healingWish: true } },
    'lunar-dance': { name: 'Lunar Dance', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { lunarDance: true } },
    'pain-split': { name: 'Pain Split', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { painSplit: true } },
    'destiny-bond': { name: 'Destiny Bond', type: 'Ghost', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { destinyBond: true } },
    'perish-song': { name: 'Perish Song', type: 'Normal', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { perishSong: true } },
    'curse': { name: 'Curse', type: 'Ghost', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { curse: true } },
    'teleport': { name: 'Teleport', type: 'Psychic', power: 0, accuracy: 100, category: 'Status', priority: -6, effects: { phaze: true } },
    'defog': { name: 'Defog', type: 'Flying', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { clearHazards: true, defog: true } },
    'memento': { name: 'Memento', type: 'Dark', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { memento: true } },
    'rapid-spin': { name: 'Rapid Spin', type: 'Normal', power: 50, accuracy: 100, category: 'Physical', priority: 0, effects: { clearHazards: true, selfBoost: { spe: 1 } } },
    'mortal-spin': { name: 'Mortal Spin', type: 'Poison', power: 30, accuracy: 100, category: 'Physical', priority: 0, effects: { clearHazards: true, status: 'PSN' } },
    'tailwind': { name: 'Tailwind', type: 'Flying', power: 0, accuracy: 100, category: 'Status', priority: 0, effects: { tailwind: true } },
    // Stat drops (status)
